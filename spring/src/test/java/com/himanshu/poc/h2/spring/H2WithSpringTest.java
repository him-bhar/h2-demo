...
*/
package com.himanshu.poc.h2.spring;
...
@ContextConfiguration(locations={"classpath:/context-dao.xml"})
public class H2WithSpringTest {
	
	private Logger logger = LoggerFactory.getLogger(H2WithSpringTest.class);
